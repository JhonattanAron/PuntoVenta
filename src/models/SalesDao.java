...
public class SalesDao {
    ...
    public boolean registerSaleQuery(int customer_id, int employee_id, double total) {
        ...
        String query = "INSERT INTO sales (customer_id, employe_id,  total, sales_date) VALUES (?,?,?,?)";
    ...
    public List listAllSalesQuery() {
        ...
        String query = "SELECT s.id AS invoice, c.full_name AS customer, e.full_name AS employee, s.total, s.sales_date FROM sales s \n"
                + "INNER JOIN customers c ON s.customer_id = c.id INNER JOIN employees e ON s.employe_id = e.id_Employees ORDER BY S.id ASC";
